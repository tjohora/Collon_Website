...
<html>
	...
	<body>
		<main>
			...
			<h2> Search results for People like/dislike Collon: </h2>
			
			<?php
				
				$whichLikeCollon = $_POST["likeCollon"];
				...
				$query = "SELECT * FROM survey WHERE question2 = :whichLikeCollon ORDER BY userName";
				
				$statement = $db->prepare($query);
				
				$statement->bindValue(":whichLikeCollon", $whichLikeCollon);
